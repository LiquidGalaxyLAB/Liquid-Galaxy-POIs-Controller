...
public class navigator_controller extends AppCompatActivity implements View.OnClickListener, View.OnTouchListener, TextWatcher {

    private Button upButton, downButton, leftButton, rightButton, zoomIn, zoomOut;

    public navigator_controller {
    ...
    {
        View rootView = inflater.inflate(android.R.layout.activity_navigator_controller, container, false);
